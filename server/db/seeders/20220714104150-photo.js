...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('Photos', [
      ...
      {
        url: 'https://picsum.photos/id/23/300/200',
        goodId: 8,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      ...
      {
        url: 'https://picsum.photos/id/26/300/200',
        goodId: 9,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        url: 'https://picsum.photos/id/27/300/200',
        goodId: 9,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      ...
      {
        url: 'https://picsum.photos/id/40/300/200',
        goodId: 14,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      ...
      {
        url: 'https://picsum.photos/id/44/300/200',
        goodId: 15,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
